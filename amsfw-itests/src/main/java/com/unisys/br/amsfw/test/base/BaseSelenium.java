...
public abstract class BaseSelenium {
	...
	protected WebElement encontrarQualquerElemento(String tag, String atributo,
			String elemento) {
	...
	protected WebElement encontrarTextAreaPorIdContendo(String elemento) {
		return driver.findElement(By.xpath("//textarea[contains(@id,'"
				+ elemento + "')]"));
	}

	protected void setSelectValue(String elemento, String value)
			throws Exception {
		new Select(encontrarSelectPorIdContendo(elemento))
	...
	protected void setSelectValueByCss(String seletor, String value)
			throws Exception {
		new Select(encontrarSelectPorCssContendo(seletor))
				.selectByVisibleText(value);
		Thread.sleep(SLEEP_SELECT);
	}

	protected void encontrarAutoCompletePorIdContendo(String elemento,
			String value) throws InterruptedException {
		driver.findElement(
				By.xpath("//input[contains(@id,'" + elemento + "')]"))
				.sendKeys("");
		driver.findElement(
				By.xpath("//input[contains(@id,'" + elemento + "')]"))
				.sendKeys(value);
	...
	protected void selecionaItemPickList(String itemLabel) throws Exception {
		...
		WebElement elemento = getDriver()
				.findElement(
						By.xpath("//li[contains(@data-item-label,'" + itemLabel
								+ "')]"));
		aguardaRetornoAjax();
	...
	protected void selecionaItemArvorePorId(String elemento) throws Exception {
		getDriver().findElement(
				By.xpath(".//*[@id='" + elemento + "']/span/span[1]")).click();
	}
	...
	protected void clicaBotaoPorId(String id) {
		getDriver().findElement(
				By.xpath("//button[contains(@id,'" + id + "')]")).click();
	}
	...
	protected String pegarValorSelectPorId(String idCampo) {
		return new Select(encontrarSelectPorIdContendo(idCampo))
	...
	protected boolean testReadOnly(String campo) {
		if (encontrarInputPorIdContendo(campo) != null
				...
				&& encontrarInputPorIdContendo(campo).getAttribute("readonly")
						.equals("true")) {
			return true;
		}
		return false;
	...
	protected boolean testReadOnlySelect(String campo) {
		if (encontrarSelectPorIdContendo(campo) != null
				...
				&& encontrarSelectPorIdContendo(campo).getAttribute("readonly")
						.equals("true")) {
			return true;
		}
		return false;
	 ...
	 * @throws Exception
	 */
	protected void setInputValue(String elemento, String value)
			throws Exception {
		limpaCampo(elemento);
		Thread.sleep(600);
	 ...
	 * @throws Exception
	 */
	protected void evidenciaSelenium(String versao, String casoDeTeste,
			String metodoTeste) throws Exception {
		File imageFile = (File) ((TakesScreenshot) getDriver())
				.getScreenshotAs(OutputType.FILE);
		String failureImageFileName = "C:\\" + versao + "\\" + casoDeTeste
				+ "\\" + metodoTeste + ".png";

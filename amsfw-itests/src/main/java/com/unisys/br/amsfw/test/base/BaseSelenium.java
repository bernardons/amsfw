...
public abstract class BaseSelenium {
	...
	private static final int SLEEP_ITEM_PICK_LIST = 3000;
	...
	public void seleniumStart() throws Exception {
		...
		// "/ms/dist/fsf/PROJ/firefox/16.0.0/bin/firefox"); //for linux
	...
	protected void selecionaItemPickList(String itemLabel) throws Exception {
		Thread.sleep(SLEEP_ITEM_PICK_LIST);
	...
	/**
	 * Seleciona um item de uma arvore.
	 * 
	 * @author OliveiMH
	 * @throws Exception
	 */
	protected void selecionaItemArvore() throws Exception {
		getDriver().findElement(By.xpath("//span[contains(@class,'ui-icon-triangle-1-e')]")).click();
		Thread.sleep(SLEEP_PICK_LIST);
	}

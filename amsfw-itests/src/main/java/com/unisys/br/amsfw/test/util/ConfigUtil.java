...
public class ConfigUtil {
	...
	public static final String PREFIX_EJB_PACKAGES = "ejb.context.package.";
	public static final String PREFIX_EXCLUDE_STATELESS_CLASSES = "exclude.stateless.class.";
	private static final String PREFIX_DB_SCHEMAS = "schemas";
	 ...
	 * @return
	 */
	public static Collection<String> getPropertiesComecandoPor(String chaveComecandoPor) {
	...
	/**
	 * Retorna as propriedades de pacotes de contexto dos EJBs.
	 * 
	 * @return
	 */
	public static Collection<String> getEJBContextPackages() {
		Collection<String> valores = new ArrayList<String>();
		for (String nomePropriedade : getPropertiesComecandoPor(PREFIX_EJB_PACKAGES)) {
			valores.add(properties.getProperty(nomePropriedade));
		}
		return valores;
	}	
	
	/**
	 * Retorna as propriedades de classes Stateless que devem ser excluidas.
	 * 
	 * @return
	 */
	public static Collection<String> getExcludeStatelessClasses() {
		Collection<String> valores = new ArrayList<String>();
		for (String nomePropriedade : getPropertiesComecandoPor(PREFIX_EXCLUDE_STATELESS_CLASSES)) {
			valores.add(properties.getProperty(nomePropriedade));
		}
		return valores;
	}	
	...
	public static String[] getDBSchemas() {
		return getProperty(PREFIX_DB_SCHEMAS).split(",");
	}	

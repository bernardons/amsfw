...
public class ClasseUtil {
	...
	protected static String getMaxLength(CampoJDBC campoJdbc) {
		if (// POSTGREE
			campoJdbc.getTipo().equals("integer") 
			|| campoJdbc.getTipo().equals("smallint")
			|| campoJdbc.getTipo().equals("numeric")
			// ORACLE
			|| campoJdbc.getTipo().toUpperCase().equals("NUMBER")) {
			return " maxlenght=\"" + campoJdbc.getPrecisaoNumerica() + "\"";
		} else if (// POSTGREE
				campoJdbc.getTipo().equals("character") 
				|| campoJdbc.getTipo().equals("character varying")
				// ORACLE
				|| campoJdbc.getTipo().toUpperCase().equals("CHAR")
				|| campoJdbc.getTipo().toUpperCase().equals("NCHAR")
				|| campoJdbc.getTipo().toUpperCase().equals("VARCHAR2")
				|| campoJdbc.getTipo().toUpperCase().equals("NVARCHAR2")) {

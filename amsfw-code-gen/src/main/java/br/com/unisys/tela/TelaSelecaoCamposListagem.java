 ...
 * 
 */
public class TelaSelecaoCamposListagem extends JFrame {
	...
	private JList getListaMetodos(JPanel panel, int posicaoVertical) {
		...
		SwingUtils.addLabel(panel, "Propriedades Listagem", posicaoVertical);
	...
	public void inicializaInterface() {
		...
		setTitle("Selecionar Campos de Listagem");
		setSize(800, 700);
	...
	private class ButtonAvancarListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			// Guarda os campos selecionados na lista de campos da listagem
			...
			modeloBase.setCamposListaPesquisa(camposSelecionados);

var App = function () {
    ...
    var handleSidebarToggler = function () {
        ...
        $('.sidebar-search input').keypress(function (e) {
            if (e.which == 13) {
                window.location.href = "extra_search.xhtml";
    ...
    var handleDateTimePickers = function () {
    	...
    	if($(".date-picker").length > 0) {
    		loadJsCssFile("assets/js/locales/date_en_US.js", "js");
    		loadJsCssFile("assets/bootstrap-datepicker/css/datepicker.css", "css");
    		loadJsCssFile("assets/bootstrap-datepicker/js/bootstrap-datepicker.js", "js");
    ...
    return {
        ...
        init: function () {
            ...
            handleMoney(); // handles form money
        },

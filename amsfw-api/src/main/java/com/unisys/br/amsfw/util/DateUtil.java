...
public final class DateUtil {
	...
	private static boolean isFDS(Date data) {
		...
		cal.setTime(data);
		return cal.get(Calendar.DAY_OF_WEEK) == Calendar.SATURDAY || cal.get(Calendar.DAY_OF_WEEK) == Calendar.SUNDAY ? true
				: false;
	}
	 ...
	 * @return
	 */
	public Date recuperarNProximoDiaUtil(Date date, int diasUteis) {
		int contador = 0;

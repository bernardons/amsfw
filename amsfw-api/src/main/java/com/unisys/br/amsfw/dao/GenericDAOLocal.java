...
public interface GenericDAOLocal<T extends Entidade, C extends Serializable> {
	 ...
	 * @return
	 */
	List<T> listarParaTXT(T entidadeFiltro, String orderBy, Object... filtrosExtras);
	...
	/**
	 * Recupera os dados para exportar para TXT.
	 * 
	 * @return
	 */
	List<Object[]> buscarDadosTXT(String campos, String tabela, String where);
}

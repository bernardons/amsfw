 ...
 *
 */
public abstract class ValorExtensoUtil {
    ...
    private static  Map<Integer, String> grandezasPlural;
    private static  Map<Integer, String> grandezasSingular;
   
    /** Nomes dos números. */
    private static  Map<Integer, String> nomes = new HashMap<Integer, String>();
    ...
    private static final String SEPARADOR_CENTENA = ",";
    ...
    static {
    	...
    	grandezasPlural = new HashMap<Integer, String>();
    	grandezasSingular = new HashMap<Integer, String>();
    ...
    /**
     * Método para traduzir o número para String.
     * @param amount
     * @return
     */
    public static String escrever(final BigDecimal amount) {
        if (null == amount) {
        	return "";
    	}
		...
		/* Se o número estiver, digamos, na casa dos milhões, a pilha deverá conter 4 elementos sendo 
		 * os dois últimos os das centenas e dos centavos, respectivamente. Assim, o expoente de dez 
		 * que representa a grandeza no topo da pilha é o número de (elementos - 2) * 3
		 */
        ...
        while (!decomposed.empty()) {
            ...
            if (valor > 0) {
                sb.append(SEPARADOR_CENTENA).append(" ");
       ...
       String saida = sb.substring(2);
       Integer index = saida.lastIndexOf(",");
       if (index == -1) {
    	   return saida;
       }
       return saida.substring(0, index).concat(" " + PARTICULA_ADITIVA).concat(saida.substring(index + 1));
    }
   
    private static StringBuffer comporNomeGrupos(int valor) {

...
public class DateUtilTest {
	...
	public void testAdicionarDiasDesprezandoSabadosDomingos() throws ParseException {
		...
		assertTrue(DateUtil.dateDiffDays(fim, new SimpleDateFormat("yyyy-MM-dd").parse("2016-06-09")) == 0);
		...
		assertTrue(!DateUtil.isSabadoOuDomingo(fim));
		assertTrue(DateUtil.dateDiffDays(fim, new SimpleDateFormat("yyyy-MM-dd").parse("2016-09-07")) == 0);
	}

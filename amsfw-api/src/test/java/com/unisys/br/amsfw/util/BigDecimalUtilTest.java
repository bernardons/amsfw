...
public class BigDecimalUtilTest {
	...
	public void testSomar() {
		...
		Assert.assertTrue("O resultado deveria ser 100013.49500!",
				BigDecimalUtil.somar(a, b)
				.equals(new BigDecimal(100013.49500).setScale(5, RoundingMode.HALF_UP)));
		
		a = null;
		Assert.assertTrue("O resultado deveria ser 13.5!",
				BigDecimalUtil.somar(a, b)
				.equals(new BigDecimal(13.5)));
		
		a = new BigDecimal(99999.995);
		b = null;
		Assert.assertTrue("O resultado deveria ser 99999.995!",
				BigDecimalUtil.somar(a, b)
				.equals(new BigDecimal(99999.995)));
		
		a = null;
		b = null;
		Assert.assertTrue("O resultado deveria ser ZERO!",
				BigDecimalUtil.somar(a, b)
	...
	public void testSubtrair() {
		...
		Assert.assertTrue("O resultado deveria ser 99986.49500!",
				BigDecimalUtil.subtrair(a, b)
				.equals(new BigDecimal(99986.49500).setScale(5, RoundingMode.HALF_UP)));

		a = null;
		Assert.assertTrue("O resultado deveria ser -13.5!",
				BigDecimalUtil.subtrair(a, b)
				.equals(new BigDecimal(13.5).negate()));

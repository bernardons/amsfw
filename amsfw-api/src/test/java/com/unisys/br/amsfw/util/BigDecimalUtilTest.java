...
public class BigDecimalUtilTest {
	...
	@Test
	public void testFormatarValorDuasCasasDecimais() {

		BigDecimal value = new BigDecimal(0.01000000000000000020816681711721685132943093776702880859375);
		String valorFormatado = BigDecimalUtil.formatarDuasCasas(value).toString();
		Assert.assertTrue("O resultado da variavel 'valorFormatado' deveria ser 0.01", "0.01".equals(valorFormatado));

		BigDecimal valueA = new BigDecimal(0.01);
		String valorFormatadoA = BigDecimalUtil.formatarDuasCasas(valueA).toString();
		Assert.assertTrue("O resultado da variavel 'valorFormatadoA' deveria ser 0.01", "0.01".equals(valorFormatadoA));

		BigDecimal valueB = new BigDecimal(12698);
		String valorFormatadoB = BigDecimalUtil.formatarDuasCasas(valueB).toString();
		Assert.assertTrue("O resultado da variavel 'valorFormatadoB' deveria ser 12698.00",
				"12698.00".equals(valorFormatadoB));
	}
